...
import { ArrowLeft, SlidersHorizontal, GitBranch, Network, Plus, Info } from "lucide-react";
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <MNavyBtn onClick={save}>Save Rule</MNavyBtn>
          </>
        }
      >
    ...
    <div>
      ...
      >
        <div style={{ display: "inline-flex", alignItems: "center", gap: 10 }}>
          ...
          <div
            style={{ fontFamily: FONTS.display, fontSize: 16, fontWeight: 800, color: tokens.text }}
          >
            Approval matrix
          </div>
          <LayerTag label="Governed" tone="governed" />
      ...
      >
        {rows.map((r, i) => (
          <tr key={i} style={{ borderBottom: `1px solid ${tokens.border}` }}>
            ...
            <td style={{ ...tdRight, fontWeight: 700, fontVariantNumeric: "tabular-nums" }}>
              {r.approvers}
            </td>
            <td style={td}>
              <StatusPill status={r.status} />
      ...
      <Modal
        ...
        footer={
          <>
            <MCancelBtn onClick={() => setOpen(false)} />
            <MNavyBtn onClick={save}>Add Row</MNavyBtn>
          </>
        }
      >
        <MField label="Module">
    ...
    <div>
      ...
      <Modal
        ...
        footer={
          <>
            <MCancelBtn onClick={() => setOpen(false)} />
            <MNavyBtn onClick={save}>Create Group</MNavyBtn>
          </>
        }
      >
